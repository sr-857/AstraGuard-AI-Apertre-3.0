"""
Base classes for monitoring adapters.

Provides:
- MonitoringAdapter: Abstract base class for adapters
- AdapterParseError: Exception for parse errors
"""
...
class AdapterParseError(Exception):
    """Exception raised when adapter fails to parse a payload."""
    pass
